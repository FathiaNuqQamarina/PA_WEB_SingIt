...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(move_uploaded_file($tmp, './file/' . $gambar_baru) & move_uploaded_file($tmplagu, './file/' . $lagu_baru)){
            ...
            $sql_upload = mysqli_query($conn_log,"INSERT INTO `topbarat`(`Penyanyi`, `Lagu`, `File`,`Gambar`,`Tanggal`) VALUES ('".$artis."','".$judul."','".$lagu_baru."','".$gambar_baru."','".$tanggal."')");
            if($sql_upload){
